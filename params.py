...
def get_args():
    ...
    # args for env
    parser.add_argument('--instance_type', type=str, default='JSP')
    ...
    # args for nameing
    parser.add_argument('--date', type=str, default='draw')
    parser.add_argument('--detail', type=str, default="no")
    # args for structure
    parser.add_argument('--rule', type=str, default='MWKR')

    # args for val/test
    parser.add_argument('--test_dir', type=str, default='./datasets/JSP/public_benchmark/ta')
    parser.add_argument('--load_weight', type=str, default='./weight/RS_JSP/best')
